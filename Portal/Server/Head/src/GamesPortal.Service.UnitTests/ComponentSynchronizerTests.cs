...
using static GamesPortal.Service.Helpers.ArtifactoryHelper;

namespace GamesPortal.Service
{
    [TestFixture]
    public partial class ComponentSynchronizerTests
    {
        IGamesPortalInternalServices _internalServices;
        ComponentSynchronizer _synchronizer;

        [SetUp]
        public void Setup()
        {
            _internalServices = GamesPortalInternalServicesHelper.Create();
            _synchronizer = CreateGameSynchronizer(Substitute.For<IArtifactorySyncronizationLogger>()); 
        }

        private ComponentSynchronizer CreateGameSynchronizer(IArtifactorySyncronizationLogger logger, params PropertySet[] propertySets)
        {
            _internalServices.ArtifactorySynchronizationManager.GetAvailablePropertySets().Returns(propertySets);
            return new ComponentSynchronizer(_internalServices, logger);
        }
        ...
        {   
            ...
            _internalServices.ArtifactorySynchronizerDataAccessLayer.Received().SubmitChanges(Arg.Any<Game>());
        }
        ...
        public void SynchronizeGame_IfIsNewGame_CheckTheNewGameProperties()
        {
            ...
            _internalServices.ArtifactorySynchronizerDataAccessLayer.SubmitChanges(Arg.Do<Game>(g =>
            {
                insertedGame = g;
            }));
        ...
        public void SynchronizeGame_IfIsNewGame_CheckTheGameTypesAdded()
        {
            ...
            Game insertedGame = null;
            _internalServices.ArtifactorySynchronizerDataAccessLayer.SubmitChanges(Arg.Do<Game>(g => insertedGame = g));
            ...
            var gameType = insertedGame.GameTypes.First(gt => gt.GameType_ID == 130017);
            ...
            gameType = insertedGame.GameTypes.First(gt => gt.GameType_ID == 9006);
            Assert.AreNotEqual(new Guid(), gameType.Row_ID, "You forgot to set Row_ID field");
            ...
            gameType = insertedGame.GameTypes.First(gt => gt.GameType_ID == 9057);
            Assert.AreNotEqual(new Guid(), gameType.Row_ID, "You forgot to set Row_ID field");
        ...
        public void SynchronizeGame_IfIsExistingGame_CheckGameTypesAreUpdated()
        {
            ...
            var gameType = existingGame.GameTypes.First(gt => gt.GameType_ID == 130017);
            Assert.AreEqual(130017, gameType.GameType_ID);
            Assert.AreEqual("Elm Street (new)", gameType.Name);

            gameType = existingGame.GameTypes.First(gt => gt.GameType_ID == 9006);
            Assert.AreEqual(9006, gameType.GameType_ID);
            Assert.AreEqual("A nightmare on Elm street PC Bingo (new)", gameType.Name);


            gameType = existingGame.GameTypes.First(gt => gt.GameType_ID == 9057);
            Assert.AreEqual(9057, gameType.GameType_ID);
        ...
        public void SynchronizeGame_NewGameOneRegulationOneVersion_InsertsOneGameVersionRow()
        {
            ...
            _internalServices.ArtifactorySynchronizerDataAccessLayer.Received().SubmitChanges(NSubstitute.Arg.Is<Game>(g => g.GameVersions.Count == 1));
        ...
        public void SynchronizeGame_IfFileIsMissing_NoVersionIsAdded()
        {
            ...
            repoDescriptor.Repository.GetComponentRegulations(130017).Returns(Array("Gibraltar"));
            repoDescriptor.Repository.GetVersionFolders(130017, "Gibraltar").Returns(Array("1.0.0.0"));
            repoDescriptor.Repository.GetArtifact(130017, "Gibraltar", "1.0.0.0").Returns(Optional<Artifact>.None());
        ...
        private Optional<Artifact> CreateStorageItemWithProperties(params ArtifactoryProperty[] properties)
        {
        ...
        public void SynchronizeGame_NewGameOneRegulationOneVersion_UseVersionPropertyIfExists()
        {
            ...
            _synchronizer.SynchronizeComponent(repoDescriptor, 130017);
            _internalServices.ArtifactorySynchronizerDataAccessLayer.Received().SubmitChanges(Arg.Is<Game>(g => g.GameVersions[0].VersionAsLong == new VersionNumber("0.1.0.0").ToLong()));
        }
        ...
        public void SynchronizeGame_NewGameOneRegulationOneVersion_UseVersionFolderIfVersionPropertyDoesntExists()
        {
            ...
            _internalServices.ArtifactorySynchronizerDataAccessLayer.Received().SubmitChanges(Arg.Is<Game>(g => g.GameVersions[0].VersionAsLong == new VersionNumber("1.0.0.0").ToLong()));
        ...
        public void SynchronizeGame_NewGameOneRegulationOneVersion_CheckNewVersionProperties()
        {
            ...
            repoDescriptor.Repository.GetComponentRegulations(130017).Returns(Array("Gibraltar"));
            repoDescriptor.Repository.GetVersionFolders(130017, "Gibraltar").Returns(Array("1.0.0.0"));
            var optionalArtifact = CreateStorageItemWithProperties(new ArtifactoryProperty("version", "0.1.0.0"), new ArtifactoryProperty(WellKnownNamesAndValues.VersionProperty, "0.1.0.0"));
            repoDescriptor.Repository.GetArtifact(130017, "Gibraltar", "1.0.0.0").Returns(optionalArtifact);
            ...
            {
                Assert.AreEqual(artifact.createdBy, insertedGame.GameVersions[0].CreatedBy);
                Assert.AreEqual(artifact.created, insertedGame.GameVersions[0].CreatedDate);
            });
            ...
            Assert.AreEqual((int)repoDescriptor.Infrastructure.GameTechnology, insertedGame.GameVersions[0].Technology);
        ...
        public void SynchronizeGame_IfTheSameVersionBelongsToMultipleRegulations_InsertItOnlyOnce()
        {
            ...
            repoDescriptor.Repository.GetVersionFolders(130017, "Gibraltar").Returns(Array("1.0.0.0"));
            repoDescriptor.Repository.GetArtifact(130017, "Gibraltar", "1.0.0.0").Returns(CreateStorageItemWithProperties(new ArtifactoryProperty("NDL.State", "InProgress")));
            repoDescriptor.Repository.GetArtifact(130017, "888Italy", "1.0.0.0").Returns(CreateStorageItemWithProperties(new ArtifactoryProperty("NDL.State", "InProgress")));
        ...
        public void SynchronizeGame_IfVersionPropertyIsDifferentBetweenRegulations_UseVersionFolder()
        {
            ...
            repoDescriptor.Repository.GetVersionFolders(130017, "Gibraltar").Returns(Array("1.0.0.0"));
            repoDescriptor.Repository.GetArtifact(130017, "888Italy", "1.0.0.0").Returns(CreateStorageItemWithProperties(new ArtifactoryProperty(WellKnownNamesAndValues.VersionProperty, "0.1.0.0")));
            repoDescriptor.Repository.GetArtifact(130017, "Gibraltar", "1.0.0.0").Returns(CreateStorageItemWithProperties(new ArtifactoryProperty(WellKnownNamesAndValues.VersionProperty, "0.0.1.0")));
        ...
        public void SynchronizeGame_IfNoVersionProperty_WriteMessageToLog()
        {
            ...
            var logger = ArtifactoryHelper.CreateMockLogger();
            ...
            var synchronizer = CreateGameSynchronizer(logger);
        ...
        public void SynchronizeGame_DuplicatedVersionFolderShouldNotBeIgnored()
        {
            ...
            repoDescriptor.Repository.GetArtifact(130017, "Gibraltar", "1.535.0.0").Returns(CreateStorageItemWithProperties(new ArtifactoryProperty(WellKnownNamesAndValues.VersionProperty, "1.535.0.0"), new ArtifactoryProperty("NDL.State", "Approved")));
        ...
        public void SynchronizeGame_ExistingGame_UpdateLongVersion()
        {
            ...
            repoDescriptor.Repository.GetComponentRegulations(130017).Returns(Array("Gibraltar"));
            repoDescriptor.Repository.GetVersionFolders(130017, "Gibraltar").Returns(Array("1.0.0.0"));
            repoDescriptor.Repository.GetArtifact(130017, "Gibraltar", "1.0.0.0").Returns(CreateStorageItemWithProperties(new ArtifactoryProperty(WellKnownNamesAndValues.VersionProperty, "0.1.0.0")));
        ...
        public void SynchronizeGame_ExistingGame_IfDownloadUrlDontExists_AddThem()
        {
            ...
            a1.Do(artifact => artifact.downloadUri = "http://artifactory/RepoName/Gibraltar/1.0.0.0/file.zip");
            ...
            a2.Do(artifact => artifact.downloadUri = "http://artifactory/RepoName/Denmark/1.0.0.0/file.zip");
        ...
        public void SynchronizeGame__ExistingGame_IfDownloadUrlsExists_UpdateThem()
        {
            ...
            var a1 = CreateStorageItemWithProperties(new ArtifactoryProperty("NDL.State", "InProgress"));
            a1.Do(artifact => artifact.downloadUri = "http://artifactory/RepoName/Gibraltar/1.0.0.0/file2.zip");
            
            var a2 = CreateStorageItemWithProperties(new ArtifactoryProperty("NDL.State", "InProgress"));
            a2.Do(artifact => artifact.downloadUri = "http://artifactory/RepoName/Denmark/1.0.0.0/file2.zip");
        ...
        [Test]
        public void CheckPropertyValue_IfPropertyIsConfiguredAsIgnored_DontWriteAnyWarnToLog()
        {
            _internalServices.ArtifactorySynchronizerDataAccessLayer.AddMockData(new GameTypeDescriptor(130017, OperatorEnum.Operator888, "Elm Street"));
            var settings = new ArtifactorySettings();
            settings.IgnoreUndefinedPropertiesValues = new IgnoredUndefinedPropertyValueSettingsCollection(new IgnoredUndefinedPropertyValueSettings("NDL.State", "XXX"));
        ...
        [Test]
        public void SynchronizeGame_IfLanguagePropertiesAreAvailable_AddTheLanguaeRecords()
        {
            var existingGame = GameRecord(130017, CreateGameTypeDescriptor(130017, "Elm Street", OperatorEnum.Operator888));
            var existingGameVersion = GameVersionRecord("1.0.0.0", existingGame.Game_ID);
            existingGame.GameVersions.Add(existingGameVersion);
            ...
            repoDescriptor.Repository.GetComponentRegulations(130017).Returns(Array("Gibraltar"));
            repoDescriptor.Repository.GetVersionFolders(130017, "Gibraltar").Returns(Array("1.0.0.0"));
            repoDescriptor.Repository.GetArtifact(130017, "Gibraltar", "1.0.0.0").Returns(CreateStorageItemWithProperties(LanguageProperty.FromLanguage("en", "hash1"), LanguageProperty.FromLanguage("it", "hash2")));
            ...
            Assert.AreEqual(2, existingGameVersion.GameVersion_Languages.Count);
