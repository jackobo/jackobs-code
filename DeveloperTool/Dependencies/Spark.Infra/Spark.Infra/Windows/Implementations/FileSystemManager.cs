...
namespace Spark.Infra.Windows
{
    public class FileSystemManager : IFileSystemManager
    {
        ...
        public byte[] ReadFileContent(string fullFileName)
        {
        ...
        public void ZipFolderContent(string sourceFolder, string zipFileName)
        {
            using (Ionic.Zip.ZipFile zipFile = new Ionic.Zip.ZipFile())
            {
                var sourceFolderDirInfo = new DirectoryInfo(sourceFolder);

                foreach (var folder in sourceFolderDirInfo.GetDirectories())
                {
                    zipFile.AddDirectory(folder.FullName, folder.Name);
                }

                foreach (var file in sourceFolderDirInfo.EnumerateFiles())
                {
        ...
        public void WriteFileContent(string file, byte[] content)
        {
