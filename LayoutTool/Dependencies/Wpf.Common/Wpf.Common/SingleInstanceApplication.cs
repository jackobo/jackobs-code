...
namespace Spark.Wpf.Common
{
...

    {
        ...
        private static TApplication CurrentApp
        {
            get
            {
                var currentProperty = typeof(TApplication).GetProperty("Current", System.Reflection.BindingFlags.Static | System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.FlattenHierarchy | System.Reflection.BindingFlags.NonPublic);
                if (currentProperty == null)
                    return default(TApplication);

                return (TApplication)currentProperty.GetValue(null, new object[0]);
            }
        }
